<?php
    ...
    //         $sql .= " (".implode(",", array_keys($fields)).") VALUES "; //Column name //The implode() function returns a string from the elements of an array.
    //         $sql .= "('".implode("','", array_values($fields))."')"; //Values
    //         // Execute the query
    ...
    // // Create object for egg sales
    // $birdsalesObject = new CrudOperation();

    // // Handle the save button for form submission
    // if(isset($_POST["birdsalessave"])){
    //     $myArray = array(
    //         "Date" => $_POST["Date"],
    //         "Amount" => $_POST["Amount"],
    //         "Revenue" => $_POST["Revenue"]
    //     );
    //     // Call the insertion method to add record to the database
    //     if($birdsalesObject->insertionMethod("birdsales", $myArray)){
    //         header("location: ../birdsales.php?msg=Insertion was successfull!");
    //     };
    // }
    // // Handle the edit button for record editing
    // if(isset($_POST["birdsalesedit"])){
    //     $id = $_POST["id"];
    //     $where = array("Sales_ID" => $id);
    //     $myArray = array(
    //         "Date" => $_POST["Date"],
    ...
    //         "Revenue" => $_POST["Revenue"]
    //     );
    //     if($birdsalesObject->updateMethod("birdsales", $where, $myArray)){
    //         header("location: ../birdsales.php?msg=Updated Successfully!");
    //     }
    // }

    // // Check if delete button was triggered
    // if(isset($_GET["birdsalesdelete"])){
    //     $id = $_GET["id"] ?? null;
    //     $where = array("Sales_ID" => $id);
    //     if($birdsPurchaseObject->deleteMethod("birdsales", $where)){
    //         header("location: ../birdsales.php?msg=Record deleted successfully!");
    //     }
    // }
    ...
    // // Create object for egg sales
    // $ruinedeggObject = new CrudOperation();

    // // Handle the save button for form submission
    // if(isset($_POST["ruinedeggsave"])){
    //     $myArray = array(
    //         "Date" => $_POST["Date"],
    //         "NumberOfEggs" => $_POST["NumberOfEggs"],
    //         "Loss" => $_POST["Loss"]
    //     );
    //     // Call the insertion method to add record to the database
    //     if($ruinedeggObject->insertionMethod("Ruinedegg", $myArray)){
    //         header("location: ../ruinedegg.php?msg=Insertion was successfull!");
    //     };
    // }
    // // Handle the edit button for record editing
    // if(isset($_POST["ruinedeggedit"])){
    //     $id = $_POST["id"];
    //     $where = array("Sales_ID" => $id);
    //     $myArray = array(
    //         "Date" => $_POST["Date"],
    ...
    //         "Loss" => $_POST["Loss"]
    //     );
    //     if($ruinedeggObject->updateMethod("Ruinedegg", $where, $myArray)){
    //         header("location: ../ruinedegg.php?msg=Updated Successfully!");
    //     }
    // }

    // // Check if delete button was triggered
    // if(isset($_GET["ruinedeggdelete"])){
    //     $id = $_GET["id"] ?? null;
    //     $where = array("Sales_ID" => $id);
    //     if($birdsPurchaseObject->deleteMethod("Ruinedegg", $where)){
    //         header("location: ../ruinedegg.php?msg=Record deleted successfully!");
    //     }
    // }
    ...
    // // Returning the total number of birds Sales
    // $databaseObject = new Database();
    // $query = "SELECT SUM(Amount) AS sum FROM `birdsales`"; 
    // $result = $databaseObject->connect()->query($query);
    // while($row = mysqli_fetch_assoc($result)){
    //     $totalNumberOfSaleBirds = $row['sum'];
    // };
    ...
    //     $mortalityRate = 0;
    // }
    // $remainingBirds = $totalNumberOfBirds - $totalDeaths - $totalNumberOfSaleBirds;
    ...
    // // Returning total revenue of eggs
    // $query = "SELECT SUM(Revenue) AS sum FROM `Sales`";
    // $result = $databaseObject->connect()->query($query);
    // while($row = mysqli_fetch_assoc($result)){
    //     $sales = $row['sum'];
    // }
    // // Returning total revenue of Birds
    // $query = "SELECT SUM(Revenue) AS sum FROM `birdsales`";
    // $result = $databaseObject->connect()->query($query);
    // while($row = mysqli_fetch_assoc($result)){
    //     $sales = $row['sum'] + $sales;
    // }
    ...
    // // Returning Birds Price per KG
    // $query = "SELECT SUM(birdsprice) AS sum FROM `Price`";
    // $result = $databaseObject->connect()->query($query);
    // while($row = mysqli_fetch_assoc($result)){
    //     $birdsprice = $row['sum'];
    // }
    // // Returning Egges per piece
    // $query = "SELECT SUM(eggsprice) AS sum FROM `Price`";
    // $result = $databaseObject->connect()->query($query);
    // while($row = mysqli_fetch_assoc($result)){
    //     $eggsprice = $row['sum'];
    // }
    ...
    // }
    // // Returning number of eggs ruined
    // $query = "SELECT SUM(NumberOfEggs) AS sum FROM `ruinedegg`";
    // $result = $databaseObject->connect()->query($query);
    // while($row = mysqli_fetch_assoc($result)){
    //     $totalruinedegg = $row['sum'];
    // }
    ...
    // }
    // $remainingEggs = $totalEggsProduced - $totalEggsSold -$totalruinedegg;
